...
def question_set(topic: str) -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "answer": "unit",
            "accepted_answers": ["unit", "units"],
        },
        {
            "id": "q4",
            "type": "fill_in_blank",
            "prompt": "Complete the method sentence: always check the ____ before applying a formula.",
            "answer": "conditions",
        },
        {
            "id": "q5",
            "type": "numeric_answer",
            "prompt": "If the score is 12 out of 20, what is the percentage?",
            "answer": "60",
            "tolerance": 0,
        },
        {
            "id": "q6",
            "type": "multi_select",
            "prompt": f"Select useful revision moves for {topic}.",
            "options": ["underline givens", "check units", "ignore conditions", "write a conclusion"],
            "answer": ["underline givens", "check units", "write a conclusion"],
        },
        {
            "id": "q7",
            "type": "matching",
            "prompt": "Match each step to its role.",
            "answer": {"givens": "extract data", "relation": "choose method", "conclusion": "answer clearly"},
        },
        {
            "id": "q8",
            "type": "ordering",
            "prompt": "Put the Bac method in order.",
            "items": ["extract givens", "state relation", "substitute", "conclude"],
            "answer": ["extract givens", "state relation", "substitute", "conclude"],
        },
        {
            "id": "q9",
            "type": "drag_and_drop",
            "prompt": "Classify answer parts.",
            "items": [{"id": "formula", "label": "formula"}, {"id": "unit", "label": "unit"}],
            "zones": ["method", "conclusion"],
            "answer": {"formula": "method", "unit": "conclusion"},
        },
        {
            "id": "q10",
            "type": "interactive_checkpoint",
            "prompt": "Type done after using the interactive element.",
            "answer": "done",
        },
    ]
