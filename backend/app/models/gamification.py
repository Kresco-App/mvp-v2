...
class QuizAttempt(Base):
    ...
    question_snapshot_json: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)
    question_snapshot_hash: Mapped[Optional[str]] = mapped_column(String(64), nullable=True, index=True)
    question_snapshot_version: Mapped[int] = mapped_column(Integer, default=1, server_default="1", nullable=False)
