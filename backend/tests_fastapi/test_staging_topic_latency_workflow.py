...
WORKFLOW_PATH = REPO_ROOT / ".github" / "workflows" / "staging-topic-latency-evidence.yml"


def test_staging_topic_latency_workflow_collects_redacted_artifact():
...
def test_staging_topic_latency_workflow_keeps_secret_out_of_job_env():
    workflow = WORKFLOW_PATH.read_text(encoding="utf-8")
