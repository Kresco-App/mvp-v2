...
export const DOMAIN_LABELS: Record<string, string> = {
  subjects: 'Matières',
  topics: 'Chapitres',
  topic_items: 'Contenus',
  tab_contents: 'Onglets pédagogiques',
  exams: 'Examens',
  'knowledge-base': 'Base pédagogique',
  resources: 'Ressources',
  quiz: 'Quiz',
  'exam-bank': 'Banque d’examens',
  'users-access': 'Utilisateurs',
  'access-billing': 'Accès',
  'progress-xp': 'Progression et XP',
  engagement: 'Engagement',
  'notes-saves-comments': 'Données communautaires',
  finance: 'Finance',
  messages: 'Messages',
  support: 'Support',
  calendar: 'Calendar',
