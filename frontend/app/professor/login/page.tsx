    ...
    <Suspense fallback={null}>
      <GuestGuard authenticatedRedirectMode="professor-only">
        ...
        <section className="w-full max-w-[440px] rounded-[16px] border border-transparent bg-white p-6 shadow-[var(--shadow-border),0_18px_44px_rgba(24,24,27,0.06)]">
          ...
          <div className="mb-7">
            <h1 className="m-0 text-balance text-[24px] font-black leading-[1.12] text-[#3f3f46]">{localizedCopy.auth.professorLoginTitle}</h1>
            <p className="m-0 mt-2 text-pretty text-[14px] leading-[1.55] text-[#71717b]">{localizedCopy.auth.professorLoginBody}</p>
          </div>
